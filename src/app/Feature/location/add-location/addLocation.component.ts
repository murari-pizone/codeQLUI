...
export class AddLocationComponent {
  ...
  constructor(private readonly service: LocationService, private readonly route: Router, readonly locConst: LocationConstant, readonly popup: MatDialog) {
  }
  ...
  SubmitLocation(): void {
    if (this.isConfirmed) {
      this.service.rows.push(this.locationData);
